...
$inputPopulate = new CategoriasController();
$core = new Core();
...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form method="POST" action="?pagina=categorias&method=storeCategoriaUpdate&id=<?php echo $_GET['id']?>">
    <?php foreach($inputPopulate->show($_GET['id']) as $value){ ?>

    <div class="input-field">
        <label for="category-name" class="label">Id</label>
        <input type="text" id="category-name" readonly name="codigo" class="input-text" value="<?php echo $value['codigo'] ?>"/>
      </div>

      <div class="input-field">
        <label for="category-name" class="label">Category Name</label>
        <input type="text" id="category-name" name="nome"class="input-text" value="<?php echo $value['nome']?>"/>
      </div>
