...
$paginar = new CategoriasController();
$contarLinksPagina = new CategoriasController();
$core = new Core();
...
<!-- Header --><body>
  ...
  <main class="content">
    ...
    <table class="data-grid">
      ...
      <?php foreach ($paginar->paginar() as $value) { ?>
      <tr class="data-row">
        ...
        <td class="data-grid-td">
           <span class="data-grid-cell-content"><?php echo $value['codigo']?></span>
        </td>
      
        <td class="data-grid-td">
          <div class="actions">
          <div class="action edit"><a href="?pagina=categorias&method=pageUpdate&id=<?= $value['codigo'] ?>">Edit</a></div>
            <div class="action delete"><a href="?pagina=categorias&method=delete&id=<?php echo $value['codigo']?>">Delete</a></div>
          </div>
        </td>
      </tr>
      <?php  } ?>
      ...
      <div class="containerPagination">
        <?php foreach ($contarLinksPagina->gerarLinkPaginacao() as $number) { ?>
          <a href="?pagina=<?= $number ?>" class="category-link"><?php echo $number ?></a>
        <?php } ?>
      </div>
      </tr>
    </table>
